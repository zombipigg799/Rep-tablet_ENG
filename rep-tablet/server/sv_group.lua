...
-- Send custom phone notifications to all team members
...
-- Get ID of the members of the group using group id
...
-- Get the group field id after the group id
...
-- Check if it is the group leader or not
