...
-- Slumpmässigt namn när det finns VPN
...
-- Skicka meddelande till alla gruppmedlemmar // Ändra aviseringstyp beroende på servern
...
-- Skicka anpassade telefonaviseringar till alla gruppmedlemmar
...
-- Få id för medlemmarna i gruppen med hjälp av grupp-id
...
-- Få antalet medlemmar i gruppen
...
-- Hämta gruppfältets id efter gruppens id
...
-- Utlösa händelse för gruppmedlemmar
...
-- Kontrollera om det är gruppledaren eller inte
...
---- Ställ in uppgifter för gruppen
...
-- Återställ partiets scen till noll
